...
<div className={classes.wrapper}>
    ...
    <div>
        <Title className={classes.title}>Current Account Information</Title>
    ...
    <div className={classes.form}>
        ...
        <CheckboxCard classNames={{ input: classes.input, label: classes.inputLabel }}
        isOwner={isOwner} setIsOwner={setIsOwner} />

        <Group justify="flex-end" mt="md">
        <Button className={classes.control} onClick={handleUpdate}>Update</Button>
        </Group>

        <Group justify="flex-end" mt="md">
        <Button className={classes.control} onClick={back}>Back</Button>
        </Group>
    </div>
    </SimpleGrid>
</div>
